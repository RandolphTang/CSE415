...
class OurAgent(KAgent):  # Keep the class name "OurAgent" so a game master
    ...
    def make_move(self, current_state, current_remark, time_limit=1000,
                  autograding=True, use_alpha_beta=False,
        ...
        if best_move:
            ...
            prompt = (
                ...
                f"Here is the board after your own move: {new_state.board}\n"+\
                f"Comment on your move,\n"+\
    ...
    def minimax(self,
        ...
        if depth_remaining == 0 or not self.has_successors(state):
            self.num_static_evals_this_turn += 1
            ...
            for i in range(len(state.board)):
                for j in range(len(state.board[0])):
                    if state.board[i][j] == ' ':
                        ...
                        #print(f"Evaluating {new_state.whose_move} at move {[i]},{[j]} depth {depth_remaining} with score {score}")
                        ...
                        if pruning:
                            ...
                            if best_move is not None and beta <= alpha:
                                self.alpha_beta_cutoffs_this_turn += 1
